    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="container mx-auto p-4 flex-grow">
        <div className="mb-6 flex justify-between items-center">
          ...
          >
            Switch to {userType !== "USER" ? "Employee" : "Customer"} View
          </Button>
        </div>
          ...
          <Tabs defaultValue="calendar" className="w-full">
            ...
            <TabsContent value="calendar">
              <div className="flex justify-center space-x-4 mb-4">
                <Button onClick={() => setSelectedDate("2023-09-25")}>
                  Sep 25
                </Button>
                <Button onClick={() => setSelectedDate("2023-09-26")}>
                  Sep 26
                </Button>
                <Button onClick={() => setSelectedDate("2023-09-27")}>
                  Sep 27
                </Button>
              </div>
              <DailyCalendar appointments={appointments} date={selectedDate} />
            </TabsContent>
