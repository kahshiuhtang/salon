            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">
                  Welcome to S&S Nails
                </h1>
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl">
                  Your premier nail salon in Staten Island. Experience luxury and style at your fingertips.
                </p>
              </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 lg:grid-cols-3 items-start">
              <Card>
                ...
                <CardContent>
                  Our skilled nail artists bring years of experience and creativity to every service.
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
                ...
                <CardContent>
                  We use only the highest quality, long-lasting nail products for beautiful, durable results.
                </CardContent>
              </Card>
              <Card>
                <CardHeader>
                ...
                <CardContent>
                  Enjoy a serene environment designed for your comfort and relaxation during your visit.
                </CardContent>
              </Card>
            </div>
          </div>
