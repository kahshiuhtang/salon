        ...
        const fetchNotifications = async () => {
            ...
            const mockNotifications: SalonNotification[] = [
                ...
                },
                {
                    ...
                    senderId: "system",
                    type: "reminder",
                    dateSent: new Date(Date.now() - 1000 * 60 * 60),
                    seen: false,
                },
                {
                    id: "3",
                    ...
                    senderId: "system",
                    type: "user",
                    dateSent: new Date(Date.now() - 1000 * 60 * 60 * 2),
                    seen: true,
                },
                {
                    id: "4",
                    ...
                    senderId: "user2",
                    type: "booking",
                    dateSent: new Date(Date.now() - 1000 * 60 * 60 * 3),
                    seen: true,
                },
                {
                    id: "5",
                    ...
                    description:
                        "Payment for your last appointment has been received",
                    senderId: "system",
                    type: "payment",
                    dateSent: new Date(Date.now() - 1000 * 60 * 60 * 4),
                    seen: true,
                },
            ];
