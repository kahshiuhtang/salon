...
// Firebase import (you'll need to set up Firebase in your project)
...
const salonServiceSchema = z.object({
  ...
  type: z.enum(["MANICURE", "TIP SET", "WAXING", "PEDICURE", "MISC"] as const),
  ...
  const onSubmit = async (data: SalonService | SalonGood) => {
    try {
      ...
      const collectionName =
        activeTab === "service" ? "salonServices" : "salonGoods";
  ...
  return (
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      <DialogTrigger asChild>
        <Button variant="outline">Add Salon Item</Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Add Salon Item</DialogTitle>
          <DialogDescription>
            Create a new salon service or good. Click save when you're done.
          </DialogDescription>
        </DialogHeader>
        <Tabs
          value={activeTab}
          onValueChange={(value) => setActiveTab(value as "service" | "good")}
        >
          ...
          <TabsContent value="service">
            <Form {...serviceForm}>
              <form
                onSubmit={serviceForm.handleSubmit(onSubmit)}
                className="space-y-8"
              >
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Manicure" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                    ...
                    <FormItem>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="TIP SET">Tip Set</SelectItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Name</FormLabel>
                      <FormControl>
                        <Input placeholder="Nail Polish" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
