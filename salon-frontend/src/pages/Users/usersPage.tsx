...
export default function UsersPage() {
  ...
  const [isIncreaseUserPriv, setIsIncreaseUserPriv] = useState<boolean>(false);
  const [isDecreaseUserPriv, setIsDecreaseUserPriv] = useState<boolean>(false);
                      ...
                      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
                        ...
                        <div className="flex flex-col items-end space-y-2">
                          ...
                          <div className="flex space-x-2">
                            <Dialog
                              open={isIncreaseUserPriv}
                              onOpenChange={setIsIncreaseUserPriv}
                            >
                              <DialogTrigger asChild>
                                <Button
                            ...
                            <Dialog
                              open={isAvailabiltyOpen}
                              onOpenChange={setIsAvailabiltyOpen}
                            >
                              <DialogTrigger asChild>
                                <Button
                                  size="icon"
                                  ...
                                  onClick={async () => {
                                    setSelectedUserCalendar(currUser);
                                    setIsAvailabiltyOpen(true);
                                    const res = await getAvailability({
                                      userId: currUser.userId,
                                    });
                                    setCurrentAvailabilities(res);
                                  }}
